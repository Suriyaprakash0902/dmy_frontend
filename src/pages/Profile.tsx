                ...
                {showProfileModal && (
                    ...
                    >
                        <motion.div
                            ...
                            className="bg-[#111111] border border-[#D4AF37]/30 rounded-2xl w-full max-w-sm max-h-[75vh] mb-24 flex flex-col shadow-[0_0_50px_rgba(212,175,55,0.15)] relative overflow-hidden"
                        >
